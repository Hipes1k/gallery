...
from accounts.manager import CustomerManager
...
class Customer(AbstractBaseUser, PermissionsMixin):
    ...
    phone_number = PhoneNumberField(
        ...
        validators=[
            RegexValidator(
                regex=r"^\+380\d{9}$",
                message="Incorrect phone number format: +380XXXXXXXXX",
            ),
        ],
    )
    ...
    avatar = models.ImageField(
        _("avatar"), upload_to="media/images/avatars", null=True, blank=True
    )
